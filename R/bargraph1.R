...
#' @examples
#' data(cdc)
#' bargraph1(~age, data = cdc, groups = gender)
#' bargraph1(~age, data = cdc, groups = gender, col = c("blue", "red"))
#' bargraph1(~age, data = cdc, groups = gender, col = c("blue", "red"), horizontal = TRUE)
#'
#' @export


bargraph1 <- function (x, data, horizontal = FALSE, type = "frequency", col = NULL, ...) {
